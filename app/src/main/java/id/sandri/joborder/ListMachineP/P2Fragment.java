...
public class P2Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMachine = view.findViewById(R.id.rv_data_printing2);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_printing2);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_printing2);
        backtotop = view.findViewById(R.id.p2backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiPrinting.getAPIService();
        Call<String> userCall = mApiService.getDataPrint2(token);
