...
public class P3Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMachine = view.findViewById(R.id.rv_data_printing3);

        shimmerFrameLayout = view.findViewById(R.id.shimmer_printing3);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_printing3);
        backtotop = view.findViewById(R.id.p3backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiPrinting.getAPIService();
        Call<String> userCall = mApiService.getDataPrint3(token);
