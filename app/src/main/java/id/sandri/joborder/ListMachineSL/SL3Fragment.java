...
public class SL3Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sl3, container, false);
        setHasOptionsMenu(true);
        setRetainInstance(true);

        loginSession = new LoginSession(getContext());
        adapter = new MachineAdapter(getContext());
        rvMachine = view.findViewById(R.id.rv_data_sliting3);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_sliting3);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_sliting3);
        backtotop = view.findViewById(R.id.sl3backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiSliting.getAPIService();
        Call<String> userCall = mApiService.getDataSliting3(token);
