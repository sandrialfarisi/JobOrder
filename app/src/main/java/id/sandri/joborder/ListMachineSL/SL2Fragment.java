...
public class SL2Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sl2, container, false);
        setHasOptionsMenu(true);
        setRetainInstance(true);

        loginSession = new LoginSession(getContext());
        adapter = new MachineAdapter(getContext());
        rvMachine = view.findViewById(R.id.rv_data_sliting2);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_sliting2);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_sliting2);
        backtotop = view.findViewById(R.id.sl2backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiSliting.getAPIService();
        Call<String> userCall = mApiService.getDataSliting2(token);
