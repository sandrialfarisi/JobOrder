 ...
 */
public class SL5Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sl5, container, false);
        setHasOptionsMenu(true);
        setRetainInstance(true);

        loginSession = new LoginSession(getContext());
        adapter = new MachineAdapter(getContext());
        rvMachine = view.findViewById(R.id.rv_data_sliting5);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_sliting5);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_sliting5);
        backtotop = view.findViewById(R.id.sl5backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiSliting.getAPIService();
        Call<String> userCall = mApiService.getDataSliting5(token);
