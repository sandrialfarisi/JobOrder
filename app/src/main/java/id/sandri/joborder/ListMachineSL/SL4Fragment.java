...
public class SL4Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_sl4, container, false);
        setHasOptionsMenu(true);
        setRetainInstance(true);

        loginSession = new LoginSession(getContext());
        adapter = new MachineAdapter(getContext());
        rvMachine = view.findViewById(R.id.rv_data_sliting4);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_sliting4);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_sliting4);
        backtotop = view.findViewById(R.id.sl4backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiSliting.getAPIService();
        Call<String> userCall = mApiService.getDataSliting4(token);
