...
import id.sandri.joborder.ApiHelper.UtilsApiDryLaminasi;
...
public class D2Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMachine = view.findViewById(R.id.rv_data_dry2);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_dry2);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_dry2);
        backtotop = view.findViewById(R.id.d2backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiDryLaminasi.getAPIService();
        Call<String> userCall = mApiService.getDataDry2(token);
