...
public class D3Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMachine = view.findViewById(R.id.rv_data_dry3);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_dry3);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_dry3);
        backtotop = view.findViewById(R.id.d3backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiDryLaminasi.getAPIService();
        Call<String> userCall = mApiService.getDataDry3(token);
