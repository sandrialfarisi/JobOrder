...
public class D1Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMachine = view.findViewById(R.id.rv_data_dry1);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_dry1);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_dry1);
        backtotop = view.findViewById(R.id.d1backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiDryLaminasi.getAPIService();
        Call<String> userCall = mApiService.getDataDry1(token);
