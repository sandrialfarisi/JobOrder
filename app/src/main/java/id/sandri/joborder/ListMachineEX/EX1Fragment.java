...
import id.sandri.joborder.ApiHelper.UtilsApiExtru;
...
public class EX1Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMachine = view.findViewById(R.id.rv_data_extru1);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_extru1);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_extru1);
        backtotop = view.findViewById(R.id.ex1backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiExtru.getAPIService();
        Call<String> userCall = mApiService.getDataExtru1(token);
