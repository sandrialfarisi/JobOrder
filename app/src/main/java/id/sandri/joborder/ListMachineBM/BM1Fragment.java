...
public class BM1Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bm1, container, false);
        setHasOptionsMenu(true);
        setRetainInstance(true);

        loginSession = new LoginSession(getContext());
        adapter = new MachineAdapter(getContext());
        rvMachine = view.findViewById(R.id.rv_data_bag1);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_bag1);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_bag1);
        backtotop = view.findViewById(R.id.bm1backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiBagMaking.getAPIService();
        Call<String> userCall = mApiService.getDataBag1(token);
