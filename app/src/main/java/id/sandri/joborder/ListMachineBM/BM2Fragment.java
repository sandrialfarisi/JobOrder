...
import id.sandri.joborder.ApiHelper.UtilsApiBagMaking;
...
public class BM2Fragment extends Fragment implements Callback<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bm2, container, false);
        setHasOptionsMenu(true);
        setRetainInstance(true);

        loginSession = new LoginSession(getContext());
        adapter = new MachineAdapter(getContext());
        rvMachine = view.findViewById(R.id.rv_data_bag2);
        shimmerFrameLayout = view.findViewById(R.id.shimmer_bag2);
        swipeRefreshLayout = view.findViewById(R.id.swipe_layout_bag2);
        backtotop = view.findViewById(R.id.bm2backtotop);

        listMachine = new ArrayList<>();
        token = loginSession.getSPToken();
        mApiService = UtilsApiBagMaking.getAPIService();
        Call<String> userCall = mApiService.getDataBag2(token);
